...
#remove stop and res positions 
stanford_bacheler_14<-stanford_bacheler[14:nrow(stanford_bacheler),]
...
#pdf('comparison_stanford_vs_bacher_axes.pdf')
plot(log10(stanford_bacheler_14_stopres$colMeansTs0+0.0001),log10(stanford_bacheler_14_stopres$colMeansTs0_stanford+0.0001),ylab="Between-patient",xlab="Within-patient", col=cols_all[stanford_bacheler_14_stopres$TypeOfSite],lwd=2,main= "Within-patient vs between-patient frequencies",xaxt = "n",yaxt = "n",cex=0.8,cex.main =0.8)
axis(1,at=(0:-4),c(0,expression(paste("10"^"-1")),expression(paste("10"^"-2")),expression(paste("10"^"-3")),expression(paste("10"^"-4"))),cex = 0.8)
axis(2,at=(0:-4),c(0,expression(paste("10"^"-1")),expression(paste("10"^"-2")),expression(paste("10"^"-3")),expression(paste("10"^"-4"))),las=2,cex =0.8)
text(median(axTicks(1)),mean(tail(axTicks(2),2)),paste("R-squared=",round(cor.test(stanford_bacheler_14_stopres$colMeansTs0,stanford_bacheler_14_stopres$colMeansTs0_stanford)$estimate * cor.test(stanford_bacheler_14_stopres$colMeansTs0,stanford_bacheler_14_stopres$colMeansTs0_stanford)$estimate,3)),cex=0.8)
#dev.off()
