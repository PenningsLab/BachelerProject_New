...
plot(log10(stanford_bacheler_14_stopres$colMeansTs0+0.0001),log10(stanford_bacheler_14_stopres$colMeansTs0_stanford+0.0001),ylab="Between-patient",xlab="Within-patient", col=cols_all[stanford_bacheler_14_stopres$TypeOfSite],lwd=2,main= "Within-patient vs between-patient frequencies",xaxt = "n",yaxt = "n",cex.axis=1.2,cex.main =1.3)
...
text(median(axTicks(1)),mean(tail(axTicks(2),2)),paste("R-squared=",round(cor.test(stanford_bacheler_14_stopres$colMeansTs0,stanford_bacheler_14_stopres$colMeansTs0_stanford)$estimate * cor.test(stanford_bacheler_14_stopres$colMeansTs0,stanford_bacheler_14_stopres$colMeansTs0_stanford)$estimate,3)),cex=1.2)
dev.off()
