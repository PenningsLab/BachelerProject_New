...
axis(1,at=(0:-4),c(1,expression(paste("10"^"-1")),expression(paste("10"^"-2")),expression(paste("10"^"-3")),expression(paste("0"))),cex = 0.8)
axis(2,at=(0:-4),c(1,expression(paste("10"^"-1")),expression(paste("10"^"-2")),expression(paste("10"^"-3")),expression(paste("0"))),las=2,cex =0.8)
