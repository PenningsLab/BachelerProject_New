...
SelCoeffnonSyn_a_noCpG_noBigC<-OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="nonsyn"&OverviewDF$WTnt=="a"&OverviewDF$makesCpG==0&OverviewDF$bigAAChange==0]
SelCoeffnonSyn_g_noCpG_noBigC<-OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="nonsyn"&OverviewDF$WTnt=="g"&OverviewDF$makesCpG==0&OverviewDF$bigAAChange==0]
wilcox.test(SelCoeffnonSyn_a_noCpG_noBigC, SelCoeffnonSyn_g_noCpG_noBigC,alternative = "less", paired = FALSE)

SelCoeffnonSyn_c_noCpG_noBigC<-OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="nonsyn"&OverviewDF$WTnt=="c"&OverviewDF$makesCpG==0&OverviewDF$bigAAChange==0]
