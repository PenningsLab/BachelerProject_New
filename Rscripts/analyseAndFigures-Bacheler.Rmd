...
OverviewDF$bigChange<-0

for(i in 1:nrow(OverviewDF)){
    WT <- amCat(OverviewDF[i,'WTAA'])
    MUT <- amCat(OverviewDF[i,'MUTAA'])
    if (WT == MUT){ OverviewDF$bigChange[i] <- 0 
    }else{
        OverviewDF$bigChange[i] <- 1
    }
}
...
Test whether G to A sites are more costly than A to G sites. 
First: only syn sites
```{r}
SelCoeffSyn_a_noCpG<-OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="syn"&OverviewDF$WTnt=="a"&OverviewDF$makesCpG==0]
SelCoeffSyn_g_noCpG<-OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="syn"&OverviewDF$WTnt=="g"&OverviewDF$makesCpG==0]
ks.test(SelCoeffSyn_a_noCpG, SelCoeffSyn_g_noCpG,alternative = "greater")

SelCoeffnonSyn_a_noCpG_noBigC<-OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="nonsyn"&OverviewDF$WTnt=="a"&OverviewDF$makesCpG==0&OverviewDF$bigChange==0]
SelCoeffnonSyn_g_noCpG_noBigC<-OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="nonsyn"&OverviewDF$WTnt=="g"&OverviewDF$makesCpG==0&OverviewDF$bigChange==0]
ks.test(SelCoeffnonSyn_a_noCpG_noBigC, SelCoeffnonSyn_g_noCpG_noBigC,alternative = "greater")

SelCoeffnonSyn_c_noCpG_noBigC<-OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="nonsyn"&OverviewDF$WTnt=="c"&OverviewDF$makesCpG==0&OverviewDF$bigChange==0]

ks.test(SelCoeffnonSyn_a_noCpG_noBigC, SelCoeffnonSyn_c_noCpG_noBigC,alternative = "greater")
```
...
plot(OverviewDF$num[40:297],OverviewDF$EstSelCoeff[40:297],log="y", 
     ylab="Cost (log scale)", xlab = "Position in Protease", xaxt="n"
     )
axis(1,at=3*c(14,35,55,75,95)-1,labels=c(14,35,55,75,95))
#Add colors for different types of sites

#A #SYN #no CPG
points(OverviewDF$num[OverviewDF$TypeOfSite=="syn"&OverviewDF$WTnt=="a"&OverviewDF$makesCpG==0],OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="syn"&OverviewDF$WTnt=="a"&OverviewDF$makesCpG==0],pch=21,bg=brewer.pal(11, "Spectral")[11])

#C #SYN #no CPG
points(OverviewDF$num[OverviewDF$TypeOfSite=="syn"&OverviewDF$WTnt=="c"&OverviewDF$makesCpG==0],OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="syn"&OverviewDF$WTnt=="c"&OverviewDF$makesCpG==0],pch=21,bg=brewer.pal(11, "Spectral")[10])

#A #SYN #CPG
points(OverviewDF$num[OverviewDF$TypeOfSite=="syn"&OverviewDF$WTnt=="a"&OverviewDF$makesCpG==1],OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="syn"&OverviewDF$WTnt=="a"&OverviewDF$makesCpG==1],pch=24,bg=brewer.pal(11, "Spectral")[11])

#C #SYN #CPG
points(OverviewDF$num[OverviewDF$TypeOfSite=="syn"&OverviewDF$WTnt=="c"&OverviewDF$makesCpG==1],OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="syn"&OverviewDF$WTnt=="c"&OverviewDF$makesCpG==1],pch=24,bg=brewer.pal(11, "Spectral")[10])

#T #SYN #no CPG
points(OverviewDF$num[OverviewDF$TypeOfSite=="syn"&OverviewDF$WTnt=="t"&OverviewDF$makesCpG==0],OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="syn"&OverviewDF$WTnt=="t"&OverviewDF$makesCpG==0],pch=21,bg=brewer.pal(11, "Spectral")[9])

#G #SYN #no CPG
points(OverviewDF$num[OverviewDF$TypeOfSite=="syn"&OverviewDF$WTnt=="t"&OverviewDF$makesCpG==0],OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="syn"&OverviewDF$WTnt=="t"&OverviewDF$makesCpG==0],pch=21,bg=brewer.pal(11, "Spectral")[8])

#A #NONSYN #no CPG
points(OverviewDF$num[OverviewDF$TypeOfSite=="nonsyn"&OverviewDF$WTnt=="a"&OverviewDF$makesCpG==0],OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="nonsyn"&OverviewDF$WTnt=="a"&OverviewDF$makesCpG==0],pch=21,col=2,bg=brewer.pal(11, "Spectral")[7])

#C #NONSYN #no CPG
points(OverviewDF$num[OverviewDF$TypeOfSite=="nonsyn"&OverviewDF$WTnt=="c"&OverviewDF$makesCpG==0],OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="nonsyn"&OverviewDF$WTnt=="c"&OverviewDF$makesCpG==0],pch=21,col=2,bg=brewer.pal(11, "Spectral")[7])

#A #NONSYN #CPG
points(OverviewDF$num[OverviewDF$TypeOfSite=="nonsyn"&OverviewDF$WTnt=="a"&OverviewDF$makesCpG==1],OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="nonsyn"&OverviewDF$WTnt=="a"&OverviewDF$makesCpG==1],pch=21,col=2,bg=brewer.pal(11, "Spectral")[6])

#C #NONSYN #CPG
points(OverviewDF$num[OverviewDF$TypeOfSite=="nonsyn"&OverviewDF$WTnt=="c"&OverviewDF$makesCpG==1],OverviewDF$EstSelCoeff[OverviewDF$TypeOfSite=="nonsyn"&OverviewDF$WTnt=="c"&OverviewDF$makesCpG==1],pch=21,col=2,bg=brewer.pal(11, "Spectral")[6])

#ADD AA CHANGE OR NOT. 
